...
const STATS: [string, string][] = [
  ...
  ['PRIVATE BETA', 'By invite · small groups'],
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'We\'re opening with a small group. When a spot opens up, we\'ll email you.',
  },
  {
...
export default function MarketingHome() {
  return (
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto w-full px-5 md:px-8 py-16 md:py-20">
      ...
      {/* ── FAQ ──────────────────────────────────────────────────────────── */}
      <section className="scroll-mt-24" style={{ borderBottom: `1px solid ${BRT.divide}` }}>
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 py-16 md:py-24">
          <Eyebrow>FAQ</Eyebrow>
